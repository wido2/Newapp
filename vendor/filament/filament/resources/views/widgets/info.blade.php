    ...
    <x-filament::section>
        <div class="flex gap-x-3 items-center">
            ...
            <div class="flex flex-col gap-y-1 items-end">
                ...
                <x-filament::link
                    color="gray"
                    href="https://github.com/wido2/Newapp"
                ...
                >
                    ...
                    {{ __('filament-panels::widgets/filament-info-widget.actions.open_github.label') }}<p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                        Versi
